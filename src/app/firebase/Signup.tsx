...
export default function  Signup (){
  ...
  return(
    <footer onClick={handleSubmit}>
      <div className='mt-20' >
        <h2 className='text-3xl mb-5 text-center'><span className='span'>S</span>ignup</h2>
        ...
        />
        <div className='mt-10'>
        <button className='w-32 h-10 border-black border-solid border 	bg-gray-800 text-white'>Signup</button>
        </div>
